    ...
    <>
      <div className={style.conteinerComanda}>
        <div className={style.containerSuperior}>
          ...
          <div className={style.infoDelivery}>
            ...
            <div className={style.enderecoInfo}>
              ...
              <h1 className={`${style.tituloDelivery} ${style.enderecoDelivery}`}>
                R. dos Pinheiros - Pinheiros, São Paulo - SP, 08142-640
              </h1>
            </div>
          </div>
        ...
        <div className={style.containerInferior}>
          ...
          <a
            href='https://www.google.com/maps/place/Fazenda+Itaim,+S%C3%A3o+Paulo+-+SP,+08142-640/@-23.566218,-46.686165,13z/data=!4m6!3m5!1s0x94ce64bf76417eb1:0x6724ec7a08e66427!8m2!3d-23.5667918!4d-46.6859585!16s%2Fg%2F1thx55pd?hl=pt-BR&entry=ttu'
            target='_blank'
